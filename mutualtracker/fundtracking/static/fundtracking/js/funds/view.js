...
$.extend(PriceChart.prototype, {
    ...
    {
        eightYears = 2.529144e+11;
        if (overviewData.length > 0) {
            this._overviewStartDate = overviewData[overviewData.length - 1][0];
            overviewMin = overviewData[0][0] - eightYears;
        } else {
            this._overviewStartDate = new Date();
            overviewMin = this._overviewStartDate - eightYears;
        }
