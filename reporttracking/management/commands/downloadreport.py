        ...
        try:
            ...
            if downloader.login():
                ...
                for fund in Fund.objects.all():
                    # The report code in PBMutual Online has no spaces, hence
                    ...
                    # Go through the listings and check whether there's any new
                    # report
                    for index, report_meta in enumerate(listing):
                        ...
                        # If the report does not exist in the database,
                        # download a copy
            ...
            raise CommandError(
                "The server couldn't fulfill the request, code=%d", exc.code)
